        ...
        <>
            <div className="md:mt-28 mt-20">
                ...
                <div id='Experience' className='flex flex-col justify-center items-center gap-6 mt-14'>
                    ...
                    <div className='border-y-2 border-[#465697] dark:border-white text-white bg-[#202741] bg-opacity-30 rounded-lg p-3 md:mx-24 mx-10 shadow-lg'>
                    ...
                    <div className='border-y-2 border-[#465697] dark:border-white text-white bg-[#202741] bg-opacity-30 rounded-lg p-4 md:mx-24 mx-10 shadow-lg'>
                        <div className='flex gap-3 py-6 md:px-16 md:mt-0 flex-col'>
